...
function Survey(props: RouteChildrenProps) {
  ...
  return (
    <UnicornLayout>
      ...
      />
      <div style={{ paddingTop: "40px", paddingLeft: "33px" }} >
      ...
      <div style={{ marginTop: "30px", marginLeft: "33px", height: "2px", border: "solid 1px #c7c8f3" }}></div>
      <div>
        {questions.map((question, i) => (
          <UnicornRadio onChecked={(checked) => onAnswer(i, checked)} key={`radio_${i}`} data={question} >
